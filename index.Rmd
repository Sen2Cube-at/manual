...
This manual is intended for Sen2Cube.at users and is not a technical documentation. It is available on [GitHub](https://github.com/Sen2Cube-at/manual). If you find any errors, missing or outdated sections, please contact info@sen2cube.at or open an issue on GitHub.

## Overview

Sen2Cube.at is a Web-based system to access semantic Earth Observation data cubes, allowing you to produce information from satellite imagery on a higher semantic level. That means getting answers to questions such as "*Which images are cloud-free in a specific area-of-interest?*", "*What was the phenology of this agricultural field in 2019?*", "*Which areas were permanently sealed in the last year?*" and many more. To obtain these results, you don't need programming or be an expert with a deeper knowledge of the raw image data.
